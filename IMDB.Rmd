...
ggplot(data = user, mapping = aes(x = imdb_score, y = num_user_for_reviews)) + geom_point() + facet_wrap( ~ country)+
   xlab("IMDB Score") + 
...
The linear model below shows that the number of voted users, number of critic reviews and duration has the most impact on the imdb score. The R-squared 0f 0.27 is extremely low which suggests the relationship between these variables is not linear even though they have a strong impact on the imdb score. 
